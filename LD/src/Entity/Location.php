...
class Location
{
    ...
    #[Assert\Type(type: "numeric", groups: ['create', 'edit'])]  # Sprawdzanie, czy to liczba
    #[Assert\Range(min: -90, max: 90, groups: ['create', 'edit'])]  # Zakres szerokości geograficznej
    private ?string $latitude = null;

    #[ORM\Column(type: Types::DECIMAL, precision: 10, scale: 7)]
    #[Assert\NotBlank(groups: ['create'])]
    #[Assert\Type(type: "numeric", groups: ['create', 'edit'])]  # Sprawdzanie, czy to liczba
    #[Assert\Range(min: -180, max: 180, groups: ['create', 'edit'])]  # Zakres długości geograficznej
